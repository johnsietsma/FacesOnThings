...
namespace UnityEngine.XR.ARSim
{
    public static class PlaneApi
    {
        ...
        {
            var planeId = NativeApi.UnityARSim_createTrackableId(Guid.NewGuid());
        ...
        {
            NativeApi.UnityARSim_removePlane(planeId);
        ...
        static void SetPlaneData(TrackableId planeId, Pose pose, Vector2[] boundaryPoints)
        {
            ...
            NativeApi.UnityARSim_setPlaneData(planeId, pose, center,
